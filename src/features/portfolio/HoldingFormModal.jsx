    ...
    >
      <div className="grid gap-5 lg:grid-cols-[1.1fr_1fr]">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--bg-elevated)] px-3 py-2 text-xs leading-5 text-[var(--text-secondary)]">
            목표 비중을 함께 입력하면 리밸런싱 화면에서 현재 비중과 목표 비중의 차이, 참고 조정 금액을 더 정확히 계산합니다.
          </div>
          ...
          <div className="rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--bg-elevated)] p-4">
            ...
            <dl className="mt-3 grid grid-cols-2 gap-3 text-xs">
              ...
              <div>
                <dt className="text-[var(--text-muted)]">예상 입력금액</dt>
