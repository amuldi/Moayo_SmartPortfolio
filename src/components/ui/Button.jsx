...
const variants = {
  ...
  danger:    'bg-[var(--negative-soft)] hover:bg-red-900/30 text-[var(--negative)] border border-[var(--negative)]/30',
  success:   'bg-[var(--positive-soft)] hover:bg-emerald-900/30 text-[var(--positive)] border border-[var(--positive)]/30',
}
...
const sizes = {
  ...
  lg: 'h-10 px-5 text-sm rounded-[var(--radius-card)]',
}
